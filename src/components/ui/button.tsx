...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground shadow hover:bg-[var(--color-primary-hover)] active:bg-[var(--color-primary-active)]',
        destructive:
          'bg-destructive text-destructive-foreground shadow-sm hover:bg-[var(--color-destructive-hover)] active:bg-[var(--color-destructive-active)]',
        outline:
        ...
        link: 'text-primary underline-offset-4 hover:underline hover:text-[var(--color-primary-hover)] active:text-[var(--color-primary-active)]',
      },
      size: {
